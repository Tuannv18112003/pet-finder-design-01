...
const palette = {
  // Tông màu: XANH (màu 8 AOE) + TRẮNG + CAM
  bg: "#ffffff",            // nền trắng chủ đạo
  surface: "#ffffff",       // surface trắng
  ink: "#1f2937",           // chữ chính (đen xám)
  muted: "#6b7280",         // chữ phụ

  // Xanh AOE (màu 8) – chủ đạo
  primary: "#2f6f66",       // xanh AOE
  primarySoft: "#e6f1ef",   // xanh nhạt cho nền phụ
  line: "#d1e3df",          // viền xanh nhạt

  // Cam cho CTA
  brand: "#e76f51",         // cam nút chính
  brand2: "#d65f43",        // cam hover

  // Phụ trợ
  mint: "#2f6f66",          // dùng chung xanh AOE
  mintSoft: "#e6f1ef",
  footer: "#2f6f66",        // footer xanh AOE
};
